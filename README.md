...
## Introduction
This is an quantum automatic test generator compatible with Qiskit version 1.0. The generator generates a configuration for each user-defined fault.
...
## Installation
At the root of cloned directory, `pip install -e .`. 
