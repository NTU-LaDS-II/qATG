...
generator = ATPG(circuit_size = 5, gate_set = gate_set, alpha = 0.99, beta = 0.999, grid_slice = GRID_SLICE, search_time = SEARCH_TIME, step = STEP, sample_time = SAMPLE_TIME, max_element = MAX_ELEMENT, min_required_effect_size = MIN_REQUIRED_EFFECT_SIZE)
